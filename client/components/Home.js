...
/*
  Notes:  What is audio doing here? (line 14)
  Can you break this up into more components?
  How can you solve the Audio warning in the console?
*/
...
export class Home extends React.Component {
	...
	strikeKey(event, note) {
		...
		// if you know to do recorder.stop(), how can you use this to turn on and off the recorder?
		setTimeout(async () => {
			...
			//can we change this file from webm to mp3 or something?
			// hint: you can just change the file extension
